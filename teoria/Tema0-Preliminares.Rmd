...
author: "Ángel F. Palomar Morales"
date: 
output: 
...
knitr::opts_chunk$set(echo = TRUE, comment = NA, engine.path = list(
  octave = "C:\\Users\\placiano\\AppData\\Local\\Programs\\GNU Octave\\Octave-6.4.0\\mingw64\\bin\\octave-cli.exe"))
library(polynom)
library(pracma)
library(knitr)
library(reticulate)
use_python("C:\\Users\\placiano\\anaconda3\\python.exe")
```
